...
Lors de l'installation du système de génération, il convient de modifier le fichier index.php, et de renseigner les paramètres de connexion à la base de données, ainsi que le nom du serveur / nom de l'algo à utiliser.
